...
### YAML
We are using Yet Another Markup Language (YAML) to specify the configuration for the network, traces, log clients, etc. The YAML parsing library we use yaml-cpp
